...
const itens = [
  ...
  },
  {
    ...
    descricao: "Estoque póprio em Brasí­lia com SLA de 24 horas para itens de alto giro.",
  },
  {
    icone: DollarSign,
  ...
  },
  {
    ...
    descricao: "Key Account Managers exclusivos para hospitais e redes clí­nicas de grande porte.",
  },
];
            ...
            >
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm font-body text-saluviaGold leading-relaxed">
                    {item.descricao}
                  </p>
                </div>
              </CardContent>
