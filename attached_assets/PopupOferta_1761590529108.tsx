  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onFechar}
          className="absolute top-4 right-4 p-2 rounded-full hover:bg-saluviaGreen text-saluviaBeige transition-colors"
          aria-label="Fechar"
        ...
        <CardContent className="p-8 space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-sm font-body text-gray-100 text-center">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-3">
                <div className="mt-0.5">
                  <Check className="w-5 h-5 text-saluviaGreen" />
                </div>
          ...
          {/* Texto legal */}
          <p className="text-xs font-body text-gray-100 text-center">
