...
const categorias = [
  {
    ...
    descricao: "Luvas, máscaras, aventais, propés e toucas.",
  ...
  },
  {
    ...
    descricao: "Campos, compressas, ataduras e curativos.",
  ...
  },
  {
    ...
    descricao: "Desfibriladores, monitores, oxímetros e DEA.",
  ...
  },
  {
    ...
    descricao: "Cateteres, seringas, agulhas, sondas e drenos.",
  ...
  },
  {
    ...
    descricao: "Materiais adaptados para uso ambulatorial.",
  ...
  },
  {
    ...
    descricao: "Equipamentos e insumos para emergências médicas.",
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg font-body text-saluviaGold leading-relaxed">
                ...
                <CardContent className="p-0 overflow-hidden">
                  ...
                  <div className="relative w-full h-48 overflow-hidden rounded-t-lg">
                    {categoria.imagem ? (
                      ...
                      <div className="text-saluviaGold text-sm italic flex items-center justify-center h-full">
                        Imagem em breve
                      </div>
                    )}
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-sm font-body text-saluviaGold/90">
                        {categoria.descricao}
                      </p>
                    </div>
                    ...
                    <ul className="space-y-2 text-left">
                      {categoria.itens.map((item, idx) => (
                        <li
                          key={idx}
                          className="text-sm font-body text-saluviaGold flex items-start gap-2"
                        >
                    ...
                    <div className="text-center">
                      ...
                      >
                        <Button
                          variant="link"
                          className="text-saluviaGold hover:text-saluviaGold p-0 h-auto font-body"
                        >
