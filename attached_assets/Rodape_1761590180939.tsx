...
export default function Rodape() {
  return (
    <footer className="saluviaGreen text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Coluna 1 - Logo e descrição */}
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-saluviaGreen text-saluviaBeige/10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex items-center justify-center w-10 h-10 rounded-lg bg-saluviaGreen text-saluviaBeige/10 hover:bg-saluviaGreen  transition-colors"
                aria-label="LinkedIn"
        ...
        <div className="border-t border-white/20 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm font-body text-white/60">
              Â© 2025 Grupo Saluvia. Todos os direitos reservados.
            </p>
            <div className="flex gap-6">
              <a href="#" className="text-sm font-body text-white/60 hover:text-white transition-colors" data-testid="link-privacidade">
                Polí­tica de Privacidade
              </a>
              <a href="#" className="text-sm font-body text-white/60 hover:text-white transition-colors" data-testid="link-termos">
                Termos de Uso
              </a>
              <a href="#" className="text-sm font-body text-white/60 hover:text-white transition-colors" data-testid="link-lgpd">
                LGPD
              </a>
            </div>
          </div>
