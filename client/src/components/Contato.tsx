...
export default function Contato() {
  return (
    <section id="contato" className="py-16 sm:py-20 bg-gradient-to-b from-saluviaGreen to-saluviaBeige/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Cabeçalho */}
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl sm:text-4xl font-title font-bold text-saluviaBeige mb-4" data-testid="text-contato-titulo">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <Card className="bg-saluviaBeige shadow-xl border-none">
            <CardContent className="p-8 space-y-6">
              <div className="space-y-4">
                <h3 className="text-2xl font-title font-bold text-saluviaGreen">
              ...
              <div className="space-y-3 py-4 border-y border-gray-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-body font-medium text-gray-900">Catálogo técnico completo</p>
                    <p className="text-xs font-body text-gray-600">Com todos os produtos e especificações</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1">
                  ...
                  <div>
                    <p className="text-sm font-body font-medium text-gray-900">Atendimento personalizado</p>
                    <p className="text-xs font-body text-gray-600">Consultor dedicado para seu segmento</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-body text-gray-700">Válido na primeira compra</p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-saluviaBeige/70 border-saluviaGold/30">
